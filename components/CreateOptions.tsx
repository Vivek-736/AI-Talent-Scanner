...
const CreateOptions = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Link href={'/dashboard/create-interview'} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm cursor-pointer hover:shadow-md transition-shadow duration-300">
